"""Small CLI bridge that lets Codex/Jules work with Fathom task manifests."""
...
def render_review_prompt(title: str, changed_files: list[str], diff_summary: str) -> str:
    ...
    return f"""You are reviewing a Pull Request for Fathom.
...
def render_prompt(task: dict[str, Any]) -> str:
    ...
    return f"""You are working on Fathom.
